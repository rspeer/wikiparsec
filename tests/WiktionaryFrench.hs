...
cloudberryFacts = [
    ...
    WiktionaryFact "variant" (term ["plaquebière","fr","n","1"]) (term ["plaque-bière","fr"]),
    WiktionaryFact "hypernym" (term ["plaquebière","fr","n","1"]) (term ["rosacées","fr"]),
    WiktionaryFact "hypernym" (term ["plaquebière","fr","n","1"]) (term ["baie","fr"]),
    WiktionaryFact "hypernym" (term ["plaquebière","fr","n","1"]) (term ["fruit charnu","fr"]),
    WiktionaryFact "hypernym" (term ["plaquebière","fr","n","1"]) (term ["fruit composé","fr"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","n","1"]) (term ["baie polaire","fr"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","n","1"]) (term ["blackbière","fr"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","n","1"]) (term ["chicouté","fr"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","n","1"]) (term ["chicoutai","fr"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","n","1"]) (term ["faux mûrier","fr"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","n","1"]) (term ["framboise jaune","fr"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","n","1"]) (term ["moréale","fr"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","n","1"]) (term ["mûre arctique","fr"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","n","1"]) (term ["mûre des marais","fr"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","n","1"]) (term ["mûrier nain","fr"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","n","1"]) (term ["plate-bière","fr"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","n","1"]) (term ["ronce des tourbières","fr"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","n","1"]) (term ["ronce petit-mûrier","fr"]),
