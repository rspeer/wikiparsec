...
cloudberryFacts = [
    ...
    WiktionaryFact "variant" (term ["plaquebière","fr","nom","1"]) (term ["plaque-bière"]),
    WiktionaryFact "hypernym" (term ["plaquebière","fr","nom","1"]) (term ["rosacées"]),
    WiktionaryFact "hypernym" (term ["plaquebière","fr","nom","1"]) (term ["baie"]),
    WiktionaryFact "hypernym" (term ["plaquebière","fr","nom","1"]) (term ["fruit charnu"]),
    WiktionaryFact "hypernym" (term ["plaquebière","fr","nom","1"]) (term ["fruit composé"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","nom","1"]) (term ["baie polaire"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","nom","1"]) (term ["blackbière"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","nom","1"]) (term ["chicouté"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","nom","1"]) (term ["chicoutai"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","nom","1"]) (term ["faux mûrier"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","nom","1"]) (term ["framboise jaune"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","nom","1"]) (term ["moréale"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","nom","1"]) (term ["mûre arctique"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","nom","1"]) (term ["mûre des marais"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","nom","1"]) (term ["mûrier nain"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","nom","1"]) (term ["plate-bière"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","nom","1"]) (term ["ronce des tourbières"]),
    WiktionaryFact "synonym" (term ["plaquebière","fr","nom","1"]) (term ["ronce petit-mûrier"]),
