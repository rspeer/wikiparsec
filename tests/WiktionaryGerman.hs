...
catFacts = [
    WiktionaryFact "hasForm/nominativ_singular" (term ["Katze","de","Substantiv"]) (term ["Katze"]),
    WiktionaryFact "hasForm/nominativ_plural" (term ["Katze","de","Substantiv"]) (term ["Katzen"]),
    WiktionaryFact "hasForm/genitiv_singular" (term ["Katze","de","Substantiv"]) (term ["Katze"]),
    WiktionaryFact "hasForm/genitiv_plural" (term ["Katze","de","Substantiv"]) (term ["Katzen"]),
    WiktionaryFact "hasForm/dativ_singular" (term ["Katze","de","Substantiv"]) (term ["Katze"]),
    WiktionaryFact "hasForm/dativ_plural" (term ["Katze","de","Substantiv"]) (term ["Katzen"]),
    WiktionaryFact "hasForm/akkusativ_singular" (term ["Katze","de","Substantiv"]) (term ["Katze"]),
    WiktionaryFact "hasForm/akkusativ_plural" (term ["Katze","de","Substantiv"]) (term ["Katzen"]),
    ...
    WiktionaryFact "hasForm/feminine" (term ["Katze","de","Substantiv","","def.1"]) (term ["Kätzin"]),
    WiktionaryFact "hasForm/masculine" (term ["Katze","de","Substantiv","","def.1"]) (term ["Kater"]),
    WiktionaryFact "hasForm/masculine" (term ["Katze","de","Substantiv","","def.1a"]) (term ["Kater"]),
    WiktionaryFact "hasForm/diminutive" (term ["Katze","de","Substantiv"]) (term ["Kätzchen"]),
    WiktionaryFact "hasForm/diminutive" (term ["Katze","de","Substantiv"]) (term ["Kätzlein"]),
